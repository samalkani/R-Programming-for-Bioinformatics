---
title: "Chapter 4 - Introduction to Bioconductor"
...
```{r 1. B. III. Installing Bioconductor}
...
```{r 1. B. IV. Install specific Bioconductor Packages}
...
```{r 2. C. Installing Bioconductor}
# if(!requireNamespace("BiocManager", quietly = TRUE))
#   installed.packages("BiocManager")BiocManager::install()

```

#### 2. C. I. Load BiocManager and Install Specific Bioconductor Packages
...
```{r 2. C. I. Load BiocManager and Install Specific Bioconductor Packages}
# library(BiocManager)
# BiocManager::install("DESeq2")

```

#### 2. C. II. Updating Bioconductor and updating identified "old" packages from source (using rtools)
...
```{r 2. C. II. Updating Bioconductor}
# Updating Bioconductor
# BiocManager::install()

# Updating the latest version of various Bioconductor packages identified as "old" from source using rtools
...
```{r 2. D. I. Listing Available Packages}
head(BiocManager::available(), n = 20)
tail(BiocManager::available(), n = 20)
...
```{r 2. D. III. Exploring Package Documentation.}
?DESeq2

```

#### 2. D. III. Exploring Package Documentation - Vignettes.

To view all available functions and vignettes for a particular package, use:

```{r 2. D. III. Exploring Package Documentation - Vignettes}
help(package = "DESeq2")
...
```{r 2. D. IV. Searching for function and Features}
browseVignettes()
...
```{r 2. D. IV. Searching for function and Features - built-in help}
