---
title: "Chapter 5 - Data Visualization for Bioinformatics"
...
#### 6. A. I. Load Libraries

```{r 6. A. I. Load Libraries}
library(devtools)
library(Biobase)
library(tidyverse)
library(ggplot2)
...
```{r 8. B. I. Installation and Setup}
...
```{r 8. B. III. Creating Your First Plot}
# Load Library
library(Gviz)
...
```{r 8. B. IV. Customizing Your Plots}
plotTracks(list(genomeTrack, geneTrack), from = 1, to = 100000,
